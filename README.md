...
Ao final dos 60 segundos, o app reproduz dois tons curtos, quando o navegador permite áudio, e mostra um gráfico temporal da frequência respiratória estimada. Faixas e marcadores posicionam pausas técnicas ≥10 segundos, picos acústicos abruptos e episódios de baixa frequência candidatos de ronco no momento em que ocorreram. A legenda traz as contagens; linha e eventos não identificam causa nem constituem diagnóstico.
