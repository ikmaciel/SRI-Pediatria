...
assert.match(html, /Manter paciente nesta sessão/);
...
assert.doesNotMatch(html, /Leitura por movimento e áudio é experimental|O app instalado continua sendo experimental/);
assert.equal((html.match(/Experimental · movimento e microfone opcional\./g) || []).length, 1);
