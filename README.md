...
Ao final dos 60 segundos, o app reproduz dois tons curtos, quando o navegador permite áudio, e mostra dois traçados sincronizados: amplitude relativa e velocidade relativa do movimento respiratório ao longo do tempo. Faixas e marcadores posicionam pausas técnicas ≥10 segundos, **tosses candidatas** (som abrupto junto com movimento), outros picos acústicos e episódios de baixa frequência candidatos de ronco. Tosse aparece antes de ronco na leitura. Os traçados são normalizados ao próprio sinal e não medem volume pulmonar, fluxo de ar nem velocidade física calibrada. O algoritmo não confirma que um evento abrupto seja tosse: choro, fala, toque ou deslocamento podem produzir o mesmo marcador.
